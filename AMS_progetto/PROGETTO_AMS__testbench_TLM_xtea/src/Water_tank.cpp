...
waterTank_TDF::waterTank_TDF( sc_core::sc_module_name ):
    ...
    sig4("sig4"),sig5("sig5"),convertionLSFtoTDF("convertionLSFtoTDF")//,sig6("sig6"),sig7("sig7")
{
   //ingresso
   //convertion.set_timestep(1,sc_core::SC_NS);
   convertion.inp(in);
   convertion.y(sig1);
