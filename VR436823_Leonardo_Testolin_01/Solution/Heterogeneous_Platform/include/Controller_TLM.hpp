                    ...
                    tlm::tlm_fw_transport_if<>
{
    public:
        ...
        //quanto di tempo per il modulo TLM LT
        tlm_utils::tlm_quantumkeeper m_qk;
        
        //definizone del payload initiator e target
        tlm::tlm_initiator_socket<> initiator_socket;
        tlm::tlm_target_socket<> target_socket;
        //costruttore con all'interno i vari parametri xtea
    ...
    //variabili interne private per la corretta funzione della xtea
    private:
        sc_time timing;
        sc_uint<32> word0;
        sc_uint<32> word1;
