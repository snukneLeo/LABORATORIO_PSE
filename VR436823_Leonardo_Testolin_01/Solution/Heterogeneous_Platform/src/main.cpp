...
{
    //creazione del file per la water e la parola criptata
    ...
    sc_trace(fileSC,tb.xtea.word0_tmp,"wor0_processed");
    sc_trace(fileSC,tb.word0_dec_rt,"word0_decr");
    sc_trace(fileSC,tb.word1_rt,"wor1");
    sc_trace(fileSC,tb.xtea.word1_tmp,"wor1_processed");
    ...
    sc_trace(fileSC,tb.xtea.contatore,"Counter");
