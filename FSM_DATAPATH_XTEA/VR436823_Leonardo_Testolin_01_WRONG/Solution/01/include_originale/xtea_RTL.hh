...
class xtea_RTL : public sc_core::sc_module
{
    ...
    protected:
        typedef enum {ST_RESET, ST_READY, ST_MODE, ST_NOTSUM, ST_MODE01, 
                      ST_NULL0, ST_NULL1,ST_NULL2,ST_NULL3,ST_NULL4,
                      ST_NULL5, ST_FOR1MODE0,ST_FOR2MODE0,ST_FOR1MODE1,
                      ST_FOR2MODE1,ST_FINALE} 
                      STATES;
