...
dist_LT::dist_LT(sc_module_name name_)
  : sc_module(name_)
...
void dist_LT::b_transport(tlm::tlm_generic_payload& trans, sc_time& t)
{
...
bool dist_LT::get_direct_mem_ptr(tlm::tlm_generic_payload& trans, tlm::tlm_dmi& dmi_data)
{
  return false;
}

tlm::tlm_sync_enum dist_LT::nb_transport_fw(tlm::tlm_generic_payload& trans, tlm::tlm_phase& phase, sc_time& t)
{
  return tlm::TLM_COMPLETED;
}

unsigned int dist_LT::transport_dbg(tlm::tlm_generic_payload& trans)
{
  return 0;
}

void dist_LT:: dist_function()
{
...
// Initialization:
void dist_LT:: end_of_elaboration()
{
