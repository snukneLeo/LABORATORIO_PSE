...
void dist_UT_testbench::invalidate_direct_mem_ptr(uint64 start_range, uint64 end_range)
{
  
}

tlm::tlm_sync_enum dist_UT_testbench::nb_transport_bw(tlm::tlm_generic_payload &  trans, tlm::tlm_phase &  phase, sc_time &  t)
{
  return tlm::TLM_COMPLETED;
}

void dist_UT_testbench::run()
{
...
dist_UT_testbench::dist_UT_testbench(sc_module_name name)
  : sc_module(name)
{
